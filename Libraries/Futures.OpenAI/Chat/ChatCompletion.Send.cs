...
{
    public static TOut Send<TOut>(this ITransformer<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> future, params OAI.ChatMessage[] messages)
    {
        return future.Next(messages, null);
    }

    public static Task<TOut> SendAsync<TOut>(this ITransformer<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> future, params OAI.ChatMessage[] messages)
    {
    ...
    public static Task<TOut> SendAsync<TOut>(this ITransformer<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> future, params string[] messages)
    {
