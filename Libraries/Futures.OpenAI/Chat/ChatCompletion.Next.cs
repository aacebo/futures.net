...
{
    public static TOut Next<TOut>(this Future<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> future, params OAI.ChatMessage[] messages)
    {
        return future.Next(messages, null);
    }

    public static TOut Next<TOut>(this Future<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> future, params string[] messages)
    {
