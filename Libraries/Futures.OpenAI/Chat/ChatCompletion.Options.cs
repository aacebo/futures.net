...
{
    public static ITransformer<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> Options<TOut>
    (
        this ITransformer<IEnumerable<OAI.ChatMessage>, OAI.ChatCompletionOptions?, TOut> future,
